...
Route::group(['middleware' => 'auth:api'], function () {
    Route::group(['middleware' => 'scope:admin,user'], function () {
        ...
        Route::get('areaList',  [AreaController::class, 'index']);
        Route::get('empleadoRoles',  [RoleController::class, 'index']);
        Route::post('storeEmpleado',  [EmpleadoController::class, 'store']);
        Route::put('updateEmpleado/{id}',  [EmpleadoController::class, 'update']);
        Route::delete('deleteEmpleado/{id}',  [EmpleadoController::class, 'delete']);
    });
